...
. Navigate to `http://localhost:4646/ui` ( or `https://localhost:4646/ui` if using External Nomad ) in your browser to access the Nomad UI. For more information on utilizing the Nomad UI, refer to the link:https://developer.hashicorp.com/nomad/tutorials/web-ui[Nomad documentation].
